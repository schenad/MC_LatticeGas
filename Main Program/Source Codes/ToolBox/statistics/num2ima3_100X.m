...
figure
hold on
markersizeA=round(100*sqrt(70/(m*n)));
markersizeB=round(100*sqrt(50/(m*n)));                            %background
...
axis([0 347 0 200])                                       %make sure the white are almost same

axis off;

set (gcf,'Position',[100,50,400,400]);                    %300,100 is the ordination; 1000,600 is the height and width for window   
...
print('-djpeg','-r800','1');%num2str(i+1));
